...
for shop, employees in data.items():
    ...
    for employee in employees:
        ...
        avg_salaries[shop] = avg_salary # bo to słownik ??? 'nowa zmienna'[sklep]=zmienna wartość
print(avg_salaries)
# print(data)

with open("../JSON cwiczenia/save.json", "w", encoding='utf-8') as json_save:
    json.dump(avg_salaries, json_save, ensure_ascii=False)
